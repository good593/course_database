...
첫 번째 노트북에서는 `PyMySQL`로 SQL을 직접 실행하고, 두 번째 노트북에서는
...
| 파일 | 설명 |
|---|---|
| `requirements.txt` | Jupyter, pandas, python-dotenv, PyMySQL, SQLAlchemy 설치 목록 |
| `mysql_db.py` | MySQL 연결을 재사용하기 위한 간단한 클래스 |
| `.env.example` | 데이터베이스 접속 정보 예시 |
| `01_python_mysql.ipynb` | Jupyter 실습 노트북 |
| `02_sqlalchemy_mysql.ipynb` | SQLAlchemy 기반 MySQL 실습 노트북 |
